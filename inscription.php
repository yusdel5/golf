<?php
    session_start();
    include('coBDD.php'); // Fichier PHP contenant la connexion à votre BDD
    ...
    if(!empty($_POST)){
        ...
        if (isset($_POST['inscription'])){
            ...
            if(empty($mail)){
                ...
                $req_mail = $DB->query("SELECT * FROM Adherent WHERE mail = ?",
                    array($mail));
            ...
            if($valid){
                ...
                $DB->insert("INSERT INTO Adherent (nom, prenom, mail, mot_de_passe) VALUES 
                    (?, ?, ?, ?, ?)", 
